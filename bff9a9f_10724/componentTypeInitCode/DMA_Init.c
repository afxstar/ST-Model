...
<group>DMA2 Channel1 config
    ...
    <list>Peripheral Inc mode
        <DMA_PeripheralInc_Disable=>Disable
        <DMA_PeripheralInc_Enable=>Enable
    <code>$dma2ch1PerphIncMode$
    <list>Memory Inc mode
        <DMA_MemoryInc_Disable=>Disable
        <DMA_MemoryInc_Enable=>Enable
    <code>$dma2ch1MemIncMode$
    <list>Peripheral data size
        <DMA_PeripheralDataSize_Byte=>Byte
        <DMA_PeripheralDataSize_HalfWord=>HalfWord
        <DMA_PeripheralDataSize_Word=>Word
    <code>$dma2ch1PerphDatSize$
    <list>Memory data size
        <DMA_MemoryDataSize_Byte=>Byte
        <DMA_MemoryDataSize_HalfWord=>HalfWord
        <DMA_MemoryDataSize_Word=>Word
    <code>$dma2ch1MemDatSize$
    <list>DMA circular mode
        <DMA_Mode_Normal=>Normal
        <DMA_Mode_Circular=>Circular
    <code>$dma2ch1CrclrMode$
    <list>DMA Priority
        <DMA_Priority_Low=>Low
        <DMA_Priority_Medium=>Medium
        <DMA_Priority_High=>High
        <DMA_Priority_VeryHigh=>VeryHigh
    <code>$dma2ch1Priority$
    <list>DMA Mem to Mem
        <DMA_M2M_Disable=>Disable
        <DMA_M2M_Enable=>Enable
    <code>$dma2ch1M2mEn$
...
<group=or>dma2 Ch1 Interrupt config
    <list>Transfer complete Interrupt
        <0=>Disable
        <DMA_IT_TC=>Enable
    <list>Half transfer Interrupt
...
<group>DMA2 Channel2 config
    ...
    <list>Peripheral Inc mode
        <DMA_PeripheralInc_Disable=>Disable
        <DMA_PeripheralInc_Enable=>Enable
    <code>$dma2ch2PerphIncMode$
    <list>Memory Inc mode
        <DMA_MemoryInc_Disable=>Disable
        <DMA_MemoryInc_Enable=>Enable
    <code>$dma2ch2MemIncMode$
    <list>Peripheral data size
        <DMA_PeripheralDataSize_Byte=>Byte
        <DMA_PeripheralDataSize_HalfWord=>HalfWord
        <DMA_PeripheralDataSize_Word=>Word
    <code>$dma2ch2PerphDatSize$
    <list>Memory data size
        <DMA_MemoryDataSize_Byte=>Byte
        <DMA_MemoryDataSize_HalfWord=>HalfWord
        <DMA_MemoryDataSize_Word=>Word
    <code>$dma2ch2MemDatSize$
    <list>DMA circular mode
        <DMA_Mode_Normal=>Normal
        <DMA_Mode_Circular=>Circular
    <code>$dma2ch2CrclrMode$
    <list>DMA Priority
        <DMA_Priority_Low=>Low
        <DMA_Priority_Medium=>Medium
        <DMA_Priority_High=>High
        <DMA_Priority_VeryHigh=>VeryHigh
    <code>$dma2ch2Priority$
    <list>DMA Mem to Mem
        <DMA_M2M_Disable=>Disable
        <DMA_M2M_Enable=>Enable
    <code>$dma2ch2M2mEn$
...
<group=or>dma2 Ch2 Interrupt config
    <list>Transfer complete Interrupt
        <0=>Disable
        <DMA_IT_TC=>Enable
    <list>Half transfer Interrupt
...
<group>DMA2 Channel3 config
    ...
    <list>Peripheral Inc mode
        <DMA_PeripheralInc_Disable=>Disable
        <DMA_PeripheralInc_Enable=>Enable
    <code>$dma2ch3PerphIncMode$
    <list>Memory Inc mode
        <DMA_MemoryInc_Disable=>Disable
        <DMA_MemoryInc_Enable=>Enable
    <code>$dma2ch3MemIncMode$
    <list>Peripheral data size
        <DMA_PeripheralDataSize_Byte=>Byte
        <DMA_PeripheralDataSize_HalfWord=>HalfWord
        <DMA_PeripheralDataSize_Word=>Word
    <code>$dma2ch3PerphDatSize$
    <list>Memory data size
        <DMA_MemoryDataSize_Byte=>Byte
        <DMA_MemoryDataSize_HalfWord=>HalfWord
        <DMA_MemoryDataSize_Word=>Word
    <code>$dma2ch3MemDatSize$
    <list>DMA circular mode
        <DMA_Mode_Normal=>Normal
        <DMA_Mode_Circular=>Circular
    <code>$dma2ch3CrclrMode$
    <list>DMA Priority
        <DMA_Priority_Low=>Low
        <DMA_Priority_Medium=>Medium
        <DMA_Priority_High=>High
        <DMA_Priority_VeryHigh=>VeryHigh
    <code>$dma2ch3Priority$
    <list>DMA Mem to Mem
        <DMA_M2M_Disable=>Disable
        <DMA_M2M_Enable=>Enable
    <code>$dma2ch3M2mEn$
...
<group=or>dma2 Ch3 Interrupt config
    <list>Transfer complete Interrupt
        <0=>Disable
        <DMA_IT_TC=>Enable
    <list>Half transfer Interrupt
...
<group>DMA2 Channel4 config
    ...
    <list>Peripheral Inc mode
        <DMA_PeripheralInc_Disable=>Disable
        <DMA_PeripheralInc_Enable=>Enable
    <code>$dma2ch4PerphIncMode$
    <list>Memory Inc mode
        <DMA_MemoryInc_Disable=>Disable
        <DMA_MemoryInc_Enable=>Enable
    <code>$dma2ch4MemIncMode$
    <list>Peripheral data size
        <DMA_PeripheralDataSize_Byte=>Byte
        <DMA_PeripheralDataSize_HalfWord=>HalfWord
        <DMA_PeripheralDataSize_Word=>Word
    <code>$dma2ch4PerphDatSize$
    <list>Memory data size
        <DMA_MemoryDataSize_Byte=>Byte
        <DMA_MemoryDataSize_HalfWord=>HalfWord
        <DMA_MemoryDataSize_Word=>Word
    <code>$dma2ch4MemDatSize$
    <list>DMA circular mode
        <DMA_Mode_Normal=>Normal
        <DMA_Mode_Circular=>Circular
    <code>$dma2ch4CrclrMode$
    <list>DMA Priority
        <DMA_Priority_Low=>Low
        <DMA_Priority_Medium=>Medium
        <DMA_Priority_High=>High
        <DMA_Priority_VeryHigh=>VeryHigh
    <code>$dma2ch4Priority$
    <list>DMA Mem to Mem
        <DMA_M2M_Disable=>Disable
        <DMA_M2M_Enable=>Enable
    <code>$dma2ch4M2mEn$
...
<group=or>dma2 Ch4 Interrupt config
    <list>Transfer complete Interrupt
        <0=>Disable
        <DMA_IT_TC=>Enable
    <list>Half transfer Interrupt
...
<group>DMA2 Channel5 config
    ...
    <list>Peripheral Inc mode
        <DMA_PeripheralInc_Disable=>Disable
        <DMA_PeripheralInc_Enable=>Enable
    <code>$dma2ch5PerphIncMode$
    <list>Memory Inc mode
        <DMA_MemoryInc_Disable=>Disable
        <DMA_MemoryInc_Enable=>Enable
    <code>$dma2ch5MemIncMode$
    <list>Peripheral data size
        <DMA_PeripheralDataSize_Byte=>Byte
        <DMA_PeripheralDataSize_HalfWord=>HalfWord
        <DMA_PeripheralDataSize_Word=>Word
    <code>$dma2ch5PerphDatSize$
    <list>Memory data size
        <DMA_MemoryDataSize_Byte=>Byte
        <DMA_MemoryDataSize_HalfWord=>HalfWord
        <DMA_MemoryDataSize_Word=>Word
    <code>$dma2ch5MemDatSize$
    <list>DMA circular mode
        <DMA_Mode_Normal=>Normal
        <DMA_Mode_Circular=>Circular
    <code>$dma2ch5CrclrMode$
    <list>DMA Priority
        <DMA_Priority_Low=>Low
        <DMA_Priority_Medium=>Medium
        <DMA_Priority_High=>High
        <DMA_Priority_VeryHigh=>VeryHigh
    <code>$dma2ch5Priority$
    <list>DMA Mem to Mem
        <DMA_M2M_Disable=>Disable
        <DMA_M2M_Enable=>Enable
    <code>$dma2ch5M2mEn$
...
<group=or>dma2 Ch5 Interrupt config
    <list>Transfer complete Interrupt
        <0=>Disable
        <DMA_IT_TC=>Enable
    <list>Half transfer Interrupt
...
<dep>
    <type>state
    <trigger>DMA2 Channel1 config->DMA2 Channel1 = Disable
	<action>DMA2 Channel1 config->Peripheral base addr = Disable
	<action>DMA2 Channel1 config->Memory base addr = Disable
	<action>DMA2 Channel1 config->Transfer direction = Disable
	<action>DMA2 Channel1 config->Buffer size[0-65535] = Disable
	<action>DMA2 Channel1 config->Peripheral Inc mode = Disable
	<action>DMA2 Channel1 config->Memory Inc mode = Disable
	<action>DMA2 Channel1 config->Peripheral data size = Disable
	<action>DMA2 Channel1 config->Memory data size = Disable
	<action>DMA2 Channel1 config->DMA circular mode = Disable
	<action>DMA2 Channel1 config->DMA Priority = Disable
	<action>DMA2 Channel1 config->DMA Mem to Mem = Disable
</dep>

<dep>
    <type>state
    <trigger>DMA2 Channel1 config->DMA2 Channel1 = Disable
	<action>DMA2 Ch1 Interrupt config = Disable
</dep>

<dep>
    <type>value
    <trigger>DMA2 Channel1 config->DMA2 Channel1 = Disable
	<action>DMA2 Ch1 Interrupt config->Transfer complete Interrupt = Disable
	<action>DMA2 Ch1 Interrupt config->Half transfer Interrupt = Disable
	<action>DMA2 Ch1 Interrupt config->Transfer error Interrupt = Disable
</dep>

<dep>
    <type>state
    <trigger>DMA2 Channel2 config->DMA2 Channel2 = Disable
	<action>DMA2 Channel2 config->Peripheral base addr = Disable
	<action>DMA2 Channel2 config->Memory base addr = Disable
	<action>DMA2 Channel2 config->Transfer direction = Disable
	<action>DMA2 Channel2 config->Buffer size[0-65535] = Disable
	<action>DMA2 Channel2 config->Peripheral Inc mode = Disable
	<action>DMA2 Channel2 config->Memory Inc mode = Disable
	<action>DMA2 Channel2 config->Peripheral data size = Disable
	<action>DMA2 Channel2 config->Memory data size = Disable
	<action>DMA2 Channel2 config->DMA circular mode = Disable
	<action>DMA2 Channel2 config->DMA Priority = Disable
	<action>DMA2 Channel2 config->DMA Mem to Mem = Disable
</dep>

<dep>
    <type>state
    <trigger>DMA2 Channel2 config->DMA2 Channel2 = Disable
	<action>DMA2 Ch2 Interrupt config = Disable
</dep>

<dep>
    <type>value
    <trigger>DMA2 Channel2 config->DMA2 Channel2 = Disable
	<action>DMA2 Ch2 Interrupt config->Transfer complete Interrupt = Disable
	<action>DMA2 Ch2 Interrupt config->Half transfer Interrupt = Disable
	<action>DMA2 Ch2 Interrupt config->Transfer error Interrupt = Disable
</dep>

<dep>
    <type>state
    <trigger>DMA2 Channel3 config->DMA2 Channel3 = Disable
	<action>DMA2 Channel3 config->Peripheral base addr = Disable
	<action>DMA2 Channel3 config->Memory base addr = Disable
	<action>DMA2 Channel3 config->Transfer direction = Disable
	<action>DMA2 Channel3 config->Buffer size[0-65535] = Disable
	<action>DMA2 Channel3 config->Peripheral Inc mode = Disable
	<action>DMA2 Channel3 config->Memory Inc mode = Disable
	<action>DMA2 Channel3 config->Peripheral data size = Disable
	<action>DMA2 Channel3 config->Memory data size = Disable
	<action>DMA2 Channel3 config->DMA circular mode = Disable
	<action>DMA2 Channel3 config->DMA Priority = Disable
	<action>DMA2 Channel3 config->DMA Mem to Mem = Disable
</dep>

<dep>
    <type>state
    <trigger>DMA2 Channel3 config->DMA2 Channel3 = Disable
	<action>DMA2 Ch3 Interrupt config = Disable
</dep>

<dep>
    <type>value
    <trigger>DMA2 Channel3 config->DMA2 Channel3 = Disable
	<action>DMA2 Ch3 Interrupt config->Transfer complete Interrupt = Disable
	<action>DMA2 Ch3 Interrupt config->Half transfer Interrupt = Disable
	<action>DMA2 Ch3 Interrupt config->Transfer error Interrupt = Disable
</dep>

<dep>
    <type>state
    <trigger>DMA2 Channel4 config->DMA2 Channel4 = Disable
	<action>DMA2 Channel4 config->Peripheral base addr = Disable
	<action>DMA2 Channel4 config->Memory base addr = Disable
	<action>DMA2 Channel4 config->Transfer direction = Disable
	<action>DMA2 Channel4 config->Buffer size[0-65535] = Disable
	<action>DMA2 Channel4 config->Peripheral Inc mode = Disable
	<action>DMA2 Channel4 config->Memory Inc mode = Disable
	<action>DMA2 Channel4 config->Peripheral data size = Disable
	<action>DMA2 Channel4 config->Memory data size = Disable
	<action>DMA2 Channel4 config->DMA circular mode = Disable
	<action>DMA2 Channel4 config->DMA Priority = Disable
	<action>DMA2 Channel4 config->DMA Mem to Mem = Disable
</dep>

<dep>
    <type>state
    <trigger>DMA2 Channel4 config->DMA2 Channel4 = Disable
	<action>DMA2 Ch4 Interrupt config = Disable
</dep>

<dep>
    <type>value
    <trigger>DMA2 Channel4 config->DMA2 Channel4 = Disable
	<action>DMA2 Ch4 Interrupt config->Transfer complete Interrupt = Disable
	<action>DMA2 Ch4 Interrupt config->Half transfer Interrupt = Disable
	<action>DMA2 Ch4 Interrupt config->Transfer error Interrupt = Disable
</dep>

<dep>
    <type>state
    <trigger>DMA2 Channel5 config->DMA2 Channel5 = Disable
	<action>DMA2 Channel5 config->Peripheral base addr = Disable
	<action>DMA2 Channel5 config->Memory base addr = Disable
	<action>DMA2 Channel5 config->Transfer direction = Disable
	<action>DMA2 Channel5 config->Buffer size[0-65535] = Disable
	<action>DMA2 Channel5 config->Peripheral Inc mode = Disable
	<action>DMA2 Channel5 config->Memory Inc mode = Disable
	<action>DMA2 Channel5 config->Peripheral data size = Disable
	<action>DMA2 Channel5 config->Memory data size = Disable
	<action>DMA2 Channel5 config->DMA circular mode = Disable
	<action>DMA2 Channel5 config->DMA Priority = Disable
	<action>DMA2 Channel5 config->DMA Mem to Mem = Disable
</dep>

<dep>
    <type>state
    <trigger>DMA2 Channel5 config->DMA2 Channel5 = Disable
	<action>DMA2 Ch5 Interrupt config = Disable
</dep>

<dep>
    <type>value
    <trigger>DMA2 Channel5 config->DMA2 Channel5 = Disable
	<action>DMA2 Ch5 Interrupt config->Transfer complete Interrupt = Disable
	<action>DMA2 Ch5 Interrupt config->Half transfer Interrupt = Disable
	<action>DMA2 Ch5 Interrupt config->Transfer error Interrupt = Disable
</dep>
*******************************<<config wizard end>>**************************/
#include "stm32f10x.h"
...
STRCMP($dma1ch7IntEn$, 0) == 0 || STRCMP($dma2ch1IntEn$, 0) == 0 || STRCMP($dma2ch2IntEn$, 0) == 0 ||\
STRCMP($dma2ch3IntEn$, 0) == 0 || STRCMP($dma2ch4IntEn$, 0) == 0 || STRCMP($dma2ch5IntEn$, 0) == 0 )
#include "misc.h"
...
#endif
#if (STRCMP($dma2ch1IntEn$, 0) == 0)
void dma2_Channel1_IRQHandler(void);
#endif
#if (STRCMP($dma2ch2IntEn$, 0) == 0)
void dma2_Channel2_IRQHandler(void);
#endif
#if (STRCMP($dma2ch3IntEn$, 0) == 0)
void dma2_Channel3_IRQHandler(void);
#endif
#if (STRCMP($dma2ch4IntEn$, 0) == 0 || STRCMP($dma2ch5IntEn$, 0) == 0)
void DMA2_Channel4_5_RQHandler(void);
#endif
#endif
...
void DMA__Init()
{
    ...
    STRCMP($dma1ch7En$, DISABLE) == 0 || STRCMP($dma2ch1En$, DISABLE) == 0 || \
	STRCMP($dma2ch2En$, DISABLE) == 0 || STRCMP($dma2ch3En$, DISABLE) == 0 || \
    STRCMP($dma2ch4En$, DISABLE) == 0 || STRCMP($dma2ch5En$, DISABLE) == 0)
    ...
    #if (STRCMP($dma2ch1En$, DISABLE) == 0)
    //PUT_A_NEW_LINE_HERE
    //
    // DMA1 Channel1 Configuration
    //
    DMA_InitStructure.DMA_PeripheralBaseAddr = (u32) $dma2ch1PerphAddr$;
    DMA_InitStructure.DMA_MemoryBaseAddr = (u32) $dma2ch1MemAddr$;
    DMA_InitStructure.DMA_DIR = $dma2ch1Dir$;

    DMA_InitStructure.DMA_BufferSize = $dma2ch1BufSize$;
    DMA_InitStructure.DMA_PeripheralInc = $dma2ch1PerphIncMode$;
    DMA_InitStructure.DMA_MemoryInc = $dma2ch1MemIncMode$;
    DMA_InitStructure.DMA_PeripheralDataSize = $dma2ch1PerphDatSize$;
    DMA_InitStructure.DMA_MemoryDataSize = $dma2ch1MemDatSize$;
    DMA_InitStructure.DMA_Mode = $dma2ch1CrclrMode$;
    DMA_InitStructure.DMA_Priority = $dma2ch1Priority$;
    DMA_InitStructure.DMA_M2M = $dma2ch1M2mEn$;
    ...
    //PUT_A_NEW_LINE_HERE
    //
    // Enables DMA2_Channel1 interrupt
    //
    DMA_ITConfig(DMA2_Channel1, $dma2ch1IntEn$, ENABLE);
    ...
    #if (STRCMP($dma2ch2En$, DISABLE) == 0)
    //PUT_A_NEW_LINE_HERE
    //
    // DMA1 Channel2 Configuration
    //
    DMA_InitStructure.DMA_PeripheralBaseAddr = (u32) $dma2ch2PerphAddr$;
    DMA_InitStructure.DMA_MemoryBaseAddr = (u32) $dma2ch2MemAddr$;
    DMA_InitStructure.DMA_DIR = $dma2ch2Dir$;

    DMA_InitStructure.DMA_BufferSize = $dma2ch2BufSize$;
    DMA_InitStructure.DMA_PeripheralInc = $dma2ch2PerphIncMode$;
    DMA_InitStructure.DMA_MemoryInc = $dma2ch2MemIncMode$;
    DMA_InitStructure.DMA_PeripheralDataSize = $dma2ch2PerphDatSize$;
    DMA_InitStructure.DMA_MemoryDataSize = $dma2ch2MemDatSize$;
    DMA_InitStructure.DMA_Mode = $dma2ch2CrclrMode$;
    DMA_InitStructure.DMA_Priority = $dma2ch2Priority$;
    DMA_InitStructure.DMA_M2M = $dma2ch2M2mEn$;
    ...
    //PUT_A_NEW_LINE_HERE
    //
    // Enables DMA2_Channel2 interrupt
    //
    DMA_ITConfig(DMA2_Channel2, $dma2ch2IntEn$, ENABLE);
    ...
    #if (STRCMP($dma2ch3En$, DISABLE) == 0)
    //PUT_A_NEW_LINE_HERE
    //
    // DMA1 Channel3 Configuration
    //
    DMA_InitStructure.DMA_PeripheralBaseAddr = (u32) $dma2ch3PerphAddr$;
    DMA_InitStructure.DMA_MemoryBaseAddr = (u32) $dma2ch3MemAddr$;
    DMA_InitStructure.DMA_DIR = $dma2ch3Dir$;

    DMA_InitStructure.DMA_BufferSize = $dma2ch3BufSize$;
    DMA_InitStructure.DMA_PeripheralInc = $dma2ch3PerphIncMode$;
    DMA_InitStructure.DMA_MemoryInc = $dma2ch3MemIncMode$;
    DMA_InitStructure.DMA_PeripheralDataSize = $dma2ch3PerphDatSize$;
    DMA_InitStructure.DMA_MemoryDataSize = $dma2ch3MemDatSize$;
    DMA_InitStructure.DMA_Mode = $dma2ch3CrclrMode$;
    DMA_InitStructure.DMA_Priority = $dma2ch3Priority$;
    DMA_InitStructure.DMA_M2M = $dma2ch3M2mEn$;
    ...
    //PUT_A_NEW_LINE_HERE
    //
    // Enables DMA2_Channel3 interrupt
    //
    DMA_ITConfig(DMA2_Channel3, $dma2ch3IntEn$, ENABLE);
    ...
    #if (STRCMP($dma2ch4En$, DISABLE) == 0)
    //PUT_A_NEW_LINE_HERE
    //
    // DMA1 Channel4 Configuration
    //
    DMA_InitStructure.DMA_PeripheralBaseAddr = (u32) $dma2ch4PerphAddr$;
    DMA_InitStructure.DMA_MemoryBaseAddr = (u32) $dma2ch4MemAddr$;
    DMA_InitStructure.DMA_DIR = $dma2ch4Dir$;

    DMA_InitStructure.DMA_BufferSize = $dma2ch4BufSize$;
    DMA_InitStructure.DMA_PeripheralInc = $dma2ch4PerphIncMode$;
    DMA_InitStructure.DMA_MemoryInc = $dma2ch4MemIncMode$;
    DMA_InitStructure.DMA_PeripheralDataSize = $dma2ch4PerphDatSize$;
    DMA_InitStructure.DMA_MemoryDataSize = $dma2ch4MemDatSize$;
    DMA_InitStructure.DMA_Mode = $dma2ch4CrclrMode$;
    DMA_InitStructure.DMA_Priority = $dma2ch4Priority$;
    DMA_InitStructure.DMA_M2M = $dma2ch4M2mEn$;
    ...
    #if (STRCMP($dma2ch5En$, DISABLE) == 0)
    //PUT_A_NEW_LINE_HERE
    //
    // DMA1 Channel5 Configuration
    //
    DMA_InitStructure.DMA_PeripheralBaseAddr = (u32) $dma2ch5PerphAddr$;
    DMA_InitStructure.DMA_MemoryBaseAddr = (u32) $dma2ch5MemAddr$;
    DMA_InitStructure.DMA_DIR = $dma2ch5Dir$;

    DMA_InitStructure.DMA_BufferSize = $dma2ch5BufSize$;
    DMA_InitStructure.DMA_PeripheralInc = $dma2ch5PerphIncMode$;
    DMA_InitStructure.DMA_MemoryInc = $dma2ch5MemIncMode$;
    DMA_InitStructure.DMA_PeripheralDataSize = $dma2ch5PerphDatSize$;
    DMA_InitStructure.DMA_MemoryDataSize = $dma2ch5MemDatSize$;
    DMA_InitStructure.DMA_Mode = $dma2ch5CrclrMode$;
    DMA_InitStructure.DMA_Priority = $dma2ch5Priority$;
    DMA_InitStructure.DMA_M2M = $dma2ch5M2mEn$;
    ...
    //PUT_A_NEW_LINE_HERE
    //
    // Enables DMA2_Channel4_5 interrupt
    //
    #if (STRCMP($dma2ch4IntEn$, 0) == 0)
    DMA_ITConfig(DMA2_Channel4, $dma2ch4IntEn$, ENABLE);
    #endif
    #if (STRCMP($dma2ch5IntEn$, 0) == 0)
    DMA_ITConfig(DMA2_Channel5, $dma2ch5IntEn$, ENABLE);
    #endif
...
//PUT_A_NEW_LINE_HERE
#if (STRCMP($dma2ch1IntEn$, 0) == 0)
/* DMA2_Channel1 Interrupt function */
void DMA2_Channel1_IRQHandler(void)
{
    //
    // add your code 
...
//PUT_A_NEW_LINE_HERE
#if (STRCMP($dma2ch2IntEn$, 0) == 0)
/* DMA2_Channel2 Interrupt function */
void DMA2_Channel2_IRQHandler(void)
{
    //
    // add your code 
...
//PUT_A_NEW_LINE_HERE
#if (STRCMP($dma2ch3IntEn$, 0) == 0)
/* DMA2_Channel3 Interrupt function */
void DMA2_Channel3_IRQHandler(void)
{
    //
    // add your code 
...
//PUT_A_NEW_LINE_HERE
#if (STRCMP($dma2ch4IntEn$, 0) == 0 || STRCMP($dma2ch5IntEn$, 0) == 0)
/* DMA2_Channel4_5_ Interrupt function */
