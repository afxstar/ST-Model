...
//PUT_A_NEW_LINE_HERE
/*************************************************************
 * TIM7 Initialization Code Template
**************************************************************/
void TIM7_Init()
{
    ...
    TIM_ARRPreloadConfig(TIM7, $autoRePrelodeEn$);
    
    //PUT_A_NEW_LINE_HERE
    
    /* Update Disable configuration. Notice:ENABLE means Disable the Update Event. */
    TIM_UpdateDisableConfig(TIM7, $updataDis$);
    ...
    TIM_SelectOnePulseMode(TIM7, $onePulseMod$);
    
    //PUT_A_NEW_LINE_HERE
    
    /* Trigger Output Mode configuration */
    TIM_SelectOutputTrigger(TIM7, $trigOutMod$);
